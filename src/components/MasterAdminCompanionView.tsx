      ...
      >
          ...
          <svg viewBox="0 0 800 220" className="w-full h-full" preserveAspectRatio="none">
            ...
            >
              ...
              <text x="560" y="103" fill="#FFFFFF" fontSize="10" fontWeight="bold" textAnchor="middle">
                ₹{(globalBusinessGenerated / 100000).toFixed(1)}L
              </text>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4 border-t border-white/5 text-center md:text-left">
          ...
          <div>
            ...
            <span className="text-[9px] font-bold text-emerald-400 flex items-center justify-center md:justify-start gap-0.5 mt-0.5"><TrendingUp size={8}/> +1</span>
          </div>
          <div>
