...
import { Calendar, CircleCheck as CheckCircle2, UserPlus, Users, Sparkles, Clock, Handshake, ArrowRight, TrendingUp, Award, Flame, Target, Shield, Zap, TrendingDown, Activity } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <motion.div 
            ...
            className="bg-white rounded-[24px] p-5 sm:p-8 border border-neutral-200/80 shadow-[0_2px_8px_rgba(11,11,13,0.03),0_8px_24px_-4px_rgba(11,11,13,0.04)] relative overflow-hidden group transition-all duration-300"
          >
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <motion.div id="chapter-quick-actions" variants={itemVariants} className="space-y-5">
            <h4 className="text-[11px] font-bold uppercase tracking-[0.2em] text-neutral-500 ml-1">Chapter Controls</h4>
