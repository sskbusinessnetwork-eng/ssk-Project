...
export function MemberTable({
  ...
  if (loading) {
    return (
      <div className="bg-white rounded-[24px] border border-neutral-100 p-16 text-center shadow-[0_4px_20px_rgba(0,0,0,0.03)] shadow-neutral-100/40">
  ...
  return (
    <div className="space-y-6">
      {/* Desktop Table View */}
      <div className="hidden md:block bg-white rounded-[16px] border border-neutral-200 shadow-sm overflow-visible">
                      ...
                      <div className="flex items-center gap-3.5">
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-2 flex-wrap mb-1">
                            <p className="font-bold text-neutral-900 text-sm leading-tight truncate">{member.name || member.displayName}</p>
                      ...
                      {showActions ? (
                        <div className="relative inline-block text-left overflow-visible">
                          ...
                          {activeMenuId === member.uid && (
                            <div className="absolute right-0 mt-1 w-48 bg-white rounded-[12px] border border-neutral-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)] py-1 z-[999] animate-in fade-in slide-in-from-top-2 duration-150">
                              <button
      ...
      <div className="md:hidden space-y-4">
        {members.length > 0 ? (
          members.map((member) => (
            <div key={member.uid} className="bg-white p-5 rounded-[24px] border border-neutral-100 shadow-[0_2px_10px_rgba(0,0,0,0.02)] shadow-neutral-100/30 space-y-4 relative overflow-hidden">
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-center gap-3.5">
                  <div className="w-12 h-12 rounded-[12px] bg-neutral-100 border border-neutral-200/60 overflow-hidden shrink-0 shadow-sm">
                    <img 
                      src={member.photoURL || `https://ui-avatars.com/api/?name=${encodeURIComponent(member.name || '')}&background=random`} 
                      className="w-full h-full object-cover"
                      referrerPolicy="no-referrer"
              ...
              <div className="grid grid-cols-2 gap-3.5 p-3.5 bg-neutral-50 rounded-[16px] border border-neutral-100/50">
                <div>
          ...
          <div className="bg-white p-12 rounded-[24px] border border-neutral-100 text-center shadow-[0_2px_10px_rgba(0,0,0,0.02)] shadow-neutral-100/30">
            <p className="text-sm font-bold text-neutral-400 uppercase tracking-widest">No members found.</p>
          </div>
        )}
      </div>
