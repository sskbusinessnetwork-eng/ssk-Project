    ...
    if (records.length === 0) {
      return (
        <div className="py-12 flex flex-col items-center justify-center text-center">
          <div className="w-20 h-20 bg-[#151C2E] rounded-[24px] flex items-center justify-center mb-6 border border-white/5 shadow-2xl">
            <Search className="text-primary w-8 h-8 opacity-50" />
          </div>
          ...
          <button 
            ...
            className="px-6 py-2.5 bg-[#151C2E] hover:bg-[#1E293B] border border-white/5 text-white rounded-[12px] font-bold text-xs uppercase tracking-wider transition-all"
          >
            Refresh Dashboard
          </button>
        </div>
            ...
            <div className="flex justify-between items-start gap-3">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest truncate mt-0.5">{r.subtitle || 'N/A'}</p>
                </div>
              </div>
              {r.badgeText && (
